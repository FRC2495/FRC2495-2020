...
public class SpinnerRaiser extends Subsystem {
	...
	public SpinnerRaiser() {
		// the double solenoid valve will send compressed air from the tank wherever needed
		upDown = new DoubleSolenoid(Ports.CAN.PCM, Ports.PCM.SPINNER_RAISER_UP, Ports.PCM.SPINNER_RAISER_DOWN); // make sure ports are properly sets in Ports.java	
	}
