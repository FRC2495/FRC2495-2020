...
public class Spinner extends Subsystem{
	...
	public void spin() {
		spinnerMotor.set(ControlMode.PercentOutput, ALMOST_MAX_PCT_OUTPUT);
	...
	public void joystickControl(Joystick joystick)
	{
		...
		double input = joystick.getRawAxis(ControllerBase.GamepadAxes.LX);
		spinnerMotor.set(ControlMode.PercentOutput, Math.abs(input)>0.25?input:0.0);
	}
}
